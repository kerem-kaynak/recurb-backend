...
func NewRouter() *gin.Engine {
	...
	router.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://127.0.0.1:5173", "http://localhost:5173", "http://localhost:8080", os.Getenv("CLIENT_HOST"), os.Getenv("SERVER_HOST")}, // Add other origins as needed
